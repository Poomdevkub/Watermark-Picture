...
image = cv2.imread('01.png', 0)  # โหลดภาพในโหมด grayscale
watermark = cv2.imread('02.png', 0)  # โหลดลายน้ำในโหมด grayscale
...
# สกัดลายน้ำ
extracted_watermark = extract_watermark(marked_image, image, alpha=0.01)
cv2.imwrite('extracted_watermark3.jpg', extracted_watermark)
